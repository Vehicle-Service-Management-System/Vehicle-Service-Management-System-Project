    ...
    <main class="main-container">
        ...
        <form action="register-service" method="post" class="serivce-form" style="display:grid;">
            ...
            <fieldset>
                ...
                </label><input type="text" name="newCustomerName"></div>
                <div class="form-content"><label>@</label><input type="email" name="newCustomerEmail"></div>
                <div class="form-content"><label>#</label><input type="text" name="newCustomerPhone"></div>
                <div class="form-content"><label>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/></svg>
                </label><input type="text" name="newCustomerAddress"></div>
            </fieldset>

            <fieldset>
                <legend>Step 2: Vehicle Information</legend>
                <div class="form-content"><label>ID</label><input type="text" name="registrationNumber" required></div>
                <div class="form-content"><label>
                ...
                </label><input type="number" name="year" required></div>
            </fieldset>
            ...
            <fieldset>
                ...
                </label><input type="text" name="serviceType" required></div>
                <div class="form-content"><label>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Zm0-480h560v-80H200v80Zm0 0v-80 80Z"/></svg>
                </label><input type="date" name="serviceDate" required></div>
                <div class="form-content"><label>$</label><input type="number" step="10" name="cost" required></div>
